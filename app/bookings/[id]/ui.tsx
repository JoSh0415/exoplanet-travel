  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Messages */}
        {successMessage && (
          <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-mono flex items-center justify-between gap-3">
            ...
            <Link href="/analytics" className="text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2 whitespace-nowrap">
              View analytics →
            </Link>
          </div>
        )}
